...
# ADD CPP /nologo /W3 /GX /O2 /I "..\..\tinyxml" /I "..\..\zip_utils" /I "..\..\CrashRpt\src" /I "..\..\CrashRpt\include" /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /D "_MBCS" /YX /FD /c
...
# ADD LINK32 kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib  wininet.lib comsupp.lib wsock32.lib Rpcrt4.lib /nologo /subsystem:windows /machine:I386 /out:"..\..\bin\CrashSender.exe"
