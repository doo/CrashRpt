...
class CActionProgressDlg : 
    public ATL::CDialogImpl<CActionProgressDlg>,
    public WTL::CDialogResize<CActionProgressDlg>
{
public:
    ...
    WTL::CStatic m_statCurAction;
    WTL::CStatic m_statActionDesc;
...
class CResendDlg : 
    public ATL::CDialogImpl<CResendDlg>,
    public WTL::CMessageFilter,
    public WTL::CDialogResize<CResendDlg>
{
public:
    enum { IDD = IDD_RESEND };
  ...
  enum eActionOnClose 
  {
    ...
    WTL::CCheckListViewCtrl m_listReports;
    WTL::CSortListViewCtrl m_listReportsSort;
    WTL::CStatic m_statSize;
    WTL::CStatic m_statConsent;
    WTL::CHyperLink m_linkPrivacyPolicy;
    WTL::CButton m_btnSendNow;
    WTL::CButton m_btnOtherActions;
    WTL::CButton m_btnShowLog;
