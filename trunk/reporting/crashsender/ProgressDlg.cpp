...
{  
    ...
    WTL::CMenu popup_menu;
    popup_menu.LoadMenu(IDR_POPUPMENU);

    WTL::CMenu submenu = popup_menu.GetSubMenu(0);  
    ...
    WTL::CString sCopySelLines = pSender->GetLangStr(_T("ProgressDlg"), _T("CopySelectedLines"));
    WTL::CString sCopyWholeLog = pSender->GetLangStr(_T("ProgressDlg"), _T("CopyTheWholeLog"));
...
int CProgressDlg::SetClipboard(WTL::CString& sData)
{
