...
public:
    ...
    ATL::CComAutoCriticalSection m_csThreadExceptionHandlers; // Synchronization lock for m_ThreadExceptionHandlers.
    ...
    ATL::CComAutoCriticalSection m_csCrashLock;        // Critical section used to synchronize thread access to this object.
