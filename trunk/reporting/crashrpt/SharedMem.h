...
{  
  ...
  BOOL  m_bAddVideo;             // whether to add video recording.
...
public:
  ...
  // Destroys a view
  __declspec(deprecated) void DestroyView(LPBYTE pViewPtr);

private:
  ATL::CAtlFileMapping<LPBYTE> m_fileMapping;
  WTL::CString m_sName; // Name of the file mapping
